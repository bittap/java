...
public class KakaoRestApiHelper {
    ...
    private static final String TALK_MEMO_SEND = "/v2/api/talk/memo/default/send";
    ...
    private String accessToken = "2LmGInM0PAUfyBF_vOyZNpk06SunwcBCb2zQego9dNsAAAFsiYQO7w";
    ...
    public String talFriend(final Map<String, String> params) {
    	return request(HttpMethodType.GET, TALK_FRIENDS_PATH, mapToParams(params));
    }
    ...
    public String sendSend(final Map<String, String> params) {
    	return request(HttpMethodType.POST, TALK_MEMO_SEND, mapToParams(params));
    }
