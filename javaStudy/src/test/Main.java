...
public class Main {
    ...
    public void test() {
        // access token 지정
        apiHelper.setAccessToken("2LmGInM0PAUfyBF_vOyZNpk06SunwcBCb2zQego9dNsAAAFsiYQO7w");

        // 푸시 알림이나 유저 아이디 리스트가 필요할 때 설정 합니다. 
        // (디벨로퍼스 내에 앱설정 메뉴를 가시면 있습니다)
        apiHelper.setAdminKey("9fbe9e34fb6578d64d3918a1a918feb2");
    ...
    public void testSend(String str) {
    	...
    	params.put("template_object","{        \"object_type\": \"text\",\r\n" + 
    			"        \"text\": \""+str+"\",\r\n" + 
    			"        \"link\": {\r\n" + 
